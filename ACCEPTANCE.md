...
- 正式版本：`v1.0.7`
- 源码提交：`f1545b170c305ea239175a3ddb02e3b1b1fab20e`
- GitHub Actions：https://github.com/Kcmose/yunlume/actions/runs/33397053439
- GitHub Release：https://github.com/Kcmose/yunlume/releases/tag/v1.0.7
- 兼容代际：`1`
...
- 标签 `v1.0.7` 指向目标提交，Release 由 GitHub Actions 创建。
...
- 在独立服务器重新下载全部资产后，`SHA256SUMS` 严格校验通过；发行清单版本、镜像和宿主机归档均固定为 `1.0.7`，`compatibilityEpoch=1`。
